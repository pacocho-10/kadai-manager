        ...
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              {/* 通知ドロップダウン */}
              {showNotifications && (
                <div className="absolute right-0 sm:right-0 left-2 sm:left-auto mt-2 w-[calc(100vw-1rem)] sm:w-80 max-w-[22rem] bg-white rounded-lg shadow-lg border border-gray-200 z-50">
